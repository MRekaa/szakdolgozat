...
\begin{document}
	...
	\begin{itemize}
		...
		\item A szükséges csomagok telepítése a virtuális környezetbe a requirements.txt segítségével.
		\item MySQL szerver futtatása a helyi gépen, és a database.txt tartalmának bemásolása sql lekérdezésbe.
	\end{itemize}
