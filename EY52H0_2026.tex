...
\begin{document}
	...
	A Visual Studio Code (röviden VS Code) egy, a Microsoft által fejlesztett, ingyenes és nyílt forráskódú kódszerkesztő. Első verziója 2015-ben jelent meg, azóta az egyik legismertebb fejlesztői eszközzé vált.
	...
	\begin{itemize}
		...
		\item A szükséges csomagok telepítése a virtuális környezetbe: 
		
		\texttt{pygame} és \texttt{mysql-connector-python}.
		\item MySQL szerver futtatása a helyi gépen, és a \texttt{labor} nevű adatbázis létrehozása.
		\item Az adatbázishoz tartozó táblák: \texttt{reactions}, \texttt{materials}, \texttt{tools}.
